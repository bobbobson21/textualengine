...
namespace EngineSettings
{
	namespace Setting //set default settings in here
	{
		...
		static BaseRenderingModifier* PostPorcessingShader = nullptr; //new g_m_GenericPostProcessingMat();
	...
	bool ChangeInRunTime(string Var, BaseRenderingModifier *BaseRenderingModifier);

	int GetUpToDateValue(string Var, int TYPEID);
	bool GetUpToDateValue(string Var, bool TYPEID);
	BaseRenderingModifier *GetUpToDateValue(string Var, BaseRenderingModifier TYPEID);
