...
namespace EngineSettings
{
	namespace Setting //set default settings in here
	{
		...
		//technically CommandConsoleCMD is not const but technically it cant change during run time

#if DEBUG
		static bool ConsoleAllowed = true;
#else
		static bool ConsoleAllowed = false;//just encase you wanted the console to be off by default in game
#endif
	}
